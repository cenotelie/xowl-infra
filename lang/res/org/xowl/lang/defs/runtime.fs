...
Declaration(Class(:Closure))
SubClassOf(:Closure :Value)
...
Declaration(Class(:JavaObject))
SubClassOf(:JavaObject :Value)
Declaration(Class(:LexicalContext))
...
Declaration(ObjectProperty(:closes))
FunctionalObjectProperty(:closes)
ObjectPropertyDomain(:closes :Closure)
ObjectPropertyRange(:closes actions:Lambda)
...
Declaration(ObjectProperty(:context))
FunctionalObjectProperty(:context)
ObjectPropertyDomain(:context :Closure)
ObjectPropertyRange(:context :LexicalContext)
...
ObjectPropertyRange(:definedAs :Closure)
...
ObjectPropertyDomain(:elements :Array)
...
Declaration(ObjectProperty(:object))
FunctionalObjectProperty(:object)
ObjectPropertyDomain(:object :JavaObject)
ObjectPropertyRange(:object owl:Thing)
...
FunctionalObjectProperty(:parent)
ObjectPropertyDomain(:parent :LexicalContext)
ObjectPropertyRange(:parent :LexicalContext)
...
FunctionalObjectProperty(:type)
ObjectPropertyDomain(:type :JavaObject)
ObjectPropertyRange(:type owl:Class)
Declaration(ObjectProperty(:upvalues))
ObjectPropertyDomain(:upvalues :LexicalContext)
ObjectPropertyRange(:upvalues :Upvalue)
Declaration(ObjectProperty(:value))
FunctionalObjectProperty(:value)
ObjectPropertyDomain(:value ObjectUnionOf(:Upvalue :Element))
ObjectPropertyRange(:value :Value)
...
ObjectPropertyDomain(:variable :Upvalue)
ObjectPropertyRange(:variable actions:CodeVariable)
...
DataPropertyDomain(:index :Element)
