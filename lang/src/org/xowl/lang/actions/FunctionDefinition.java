...
public class FunctionDefinition implements org.xowl.lang.actions.FunctionAxiom, org.xowl.lang.owl2.Axiom, org.xowl.lang.actions.FunctionAxiom_OR_Invoke, org.xowl.lang.owl2.Annotation_OR_Axiom_OR_Ontology, org.xowl.lang.owl2.Axiom_OR_Statement {
    ...
    private static class line_impl implements org.xowl.lang.owl2.Axiom_OR_Statement.line {
        private org.xowl.lang.actions.FunctionDefinition domain;
        ...
        public line_impl(org.xowl.lang.actions.FunctionDefinition domain) {
            this.domain = domain;
        }
    }
    ...
    private static class function_impl implements org.xowl.lang.actions.FunctionAxiom_OR_Invoke.function {
        ...
        public function_impl(org.xowl.lang.actions.FunctionDefinition domain) {
            this.domain = domain;
        }
    }
    ...
    private static class annotations_impl implements org.xowl.lang.owl2.Annotation_OR_Axiom_OR_Ontology.annotations {
        ...
        public annotations_impl(org.xowl.lang.actions.FunctionDefinition domain) {
            this.domain = domain;
    ...
    private static class file_impl implements org.xowl.lang.owl2.Axiom_OR_Statement.file {
        ...
        public file_impl(org.xowl.lang.actions.FunctionDefinition domain) {
            this.domain = domain;
        }
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Property behavior">
    ...
    private static class behavior_impl implements org.xowl.lang.actions.FunctionDefinition.behavior {
        private org.xowl.lang.actions.FunctionDefinition domain;
        ...
        public behavior_impl(org.xowl.lang.actions.FunctionDefinition domain) {
            this.domain = domain;
        }
    }
    private behavior_impl dataBehavior;
    public org.xowl.lang.actions.FunctionDefinition.behavior __getImplOfbehavior() { return dataBehavior; }
    public boolean setBehavior(org.xowl.lang.actions.ExecutableExpression elem) {
        if (dataBehavior.get() != null) {
            if (elem == null) {
                if (!dataBehavior.user_check_remove(dataBehavior.get())) return false;
                dataBehavior.user_remove(dataBehavior.get());
            } else {
                if (!dataBehavior.user_check_replace(dataBehavior.get(), elem)) return false;
                dataBehavior.user_remove(dataBehavior.get());
                dataBehavior.user_add(elem);
            }
        } else {
            if (elem == null) return true;
            if (!dataBehavior.user_check_add(elem)) return false;
            dataBehavior.user_add(elem);
        }
        return true;
    }
    public org.xowl.lang.actions.ExecutableExpression getBehavior() { return dataBehavior.get(); }
    // </editor-fold>
    ...
    public FunctionDefinition() {
        ...
        dataBehavior = new behavior_impl(this);
    }
