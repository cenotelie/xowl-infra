...
public class ArrayElement implements org.xowl.lang.actions.ArrayExpression, org.xowl.lang.actions.ExecutableExpression, org.xowl.lang.actions.FunctionExpression, org.xowl.lang.owl2.ClassExpression, org.xowl.lang.owl2.DataPropertyExpression, org.xowl.lang.owl2.Datarange, org.xowl.lang.owl2.EntityExpression, org.xowl.lang.owl2.IndividualExpression, org.xowl.lang.owl2.LiteralExpression, org.xowl.lang.owl2.ObjectPropertyExpression, org.xowl.lang.interop.JavaObjectExpression, org.xowl.lang.actions.ArrayElement_OR_ForEach_OR_LengthOf_OR_Slice_OR_ToSeq, org.xowl.lang.owl2.Expression {
    ...
    private static class array_impl implements org.xowl.lang.actions.ArrayElement_OR_ForEach_OR_LengthOf_OR_Slice_OR_ToSeq.array {
        private org.xowl.lang.actions.ArrayElement domain;
        ...
        public array_impl(org.xowl.lang.actions.ArrayElement domain) {
            this.domain = domain;
        }
    }
    ...
    private static class index_impl implements org.xowl.lang.actions.ArrayElement.index {
        private org.xowl.lang.actions.ArrayElement domain;
        ...
        public index_impl(org.xowl.lang.actions.ArrayElement domain) {
            this.domain = domain;
        }
    }
    private index_impl dataIndex;
    public org.xowl.lang.actions.ArrayElement.index __getImplOfindex() { return dataIndex; }
    public boolean setIndex(org.xowl.lang.owl2.LiteralExpression elem) {
        if (dataIndex.get() != null) {
            if (elem == null) {
                if (!dataIndex.user_check_remove(dataIndex.get())) return false;
                dataIndex.user_remove(dataIndex.get());
            } else {
                if (!dataIndex.user_check_replace(dataIndex.get(), elem)) return false;
                dataIndex.user_remove(dataIndex.get());
                dataIndex.user_add(elem);
            }
        } else {
            if (elem == null) return true;
            if (!dataIndex.user_check_add(elem)) return false;
            dataIndex.user_add(elem);
        }
        return true;
    }
    public org.xowl.lang.owl2.LiteralExpression getIndex() { return dataIndex.get(); }
    // </editor-fold>
