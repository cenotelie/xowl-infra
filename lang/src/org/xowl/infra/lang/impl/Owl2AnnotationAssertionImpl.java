...
/**
 * The default implementation for AnnotationAssertion
 * Original OWL class is http://xowl.org/infra/lang/owl2#AnnotationAssertion
 *
 * @author xOWL code generator
 */
public class Owl2AnnotationAssertionImpl implements AnnotationAssertion {
    /**
     ...
     * This implements the storage for original OWL property http://xowl.org/infra/lang/owl2#annotSubject
     */
    private AnnotationSubject __implAnnotSubject;
     ...
     * @param elem The element value to add (must not be null)
     */
    protected void doSimpleAddAnnotSubject(AnnotationSubject elem) {
     ...
     * @param elem The element value to remove (must not be null)
     */
    protected void doSimpleRemoveAnnotSubject(AnnotationSubject elem) {
     ...
     * @param elem The element value to add (must not be null)
     */
    private void doPropertyAddAnnotSubject(AnnotationSubject elem) {
     ...
     * @param elem The element value to remove (must not be null)
     */
    private void doPropertyRemoveAnnotSubject(AnnotationSubject elem) {
     ...
     * @param elem The element value to add (must not be null)
     */
    private void doGraphAddAnnotSubject(AnnotationSubject elem) {
     ...
     * @param elem The element value to remove (must not be null)
     */
    private void doGraphRemoveAnnotSubject(AnnotationSubject elem) {
     ...
     * @param elem The element value to add (must not be null)
     */
    private void doDispatchAddAnnotSubject(AnnotationSubject elem) {
     ...
     * @param elem The element value to remove (must not be null)
     */
    private void doDispatchRemoveAnnotSubject(AnnotationSubject elem) {
        doGraphRemoveAnnotSubject(elem);
    }

    @Override
    public AnnotationSubject getAnnotSubject() {
        return __implAnnotSubject;
    }

    @Override
    public void setAnnotSubject(AnnotationSubject elem) {
    ...
    public Owl2AnnotationAssertionImpl() {
        ...
        // initialize property http://xowl.org/infra/lang/owl2#annotSubject
