 ...
 */
public class Owl2LiteralImpl implements org.xowl.infra.lang.owl2.Literal {
    /**
     ...
     */
    private org.xowl.infra.lang.owl2.IRI __implMemberOf;
     ...
     */
    protected void doSimpleAddMemberOf(org.xowl.infra.lang.owl2.IRI elem) {
        __implMemberOf = elem;
    }
     ...
     */
    protected void doSimpleRemoveMemberOf(org.xowl.infra.lang.owl2.IRI elem) {
        __implMemberOf = null;
    }
     ...
     * @param elem The element value to add (must not be null)
     */
    private void doPropertyAddMemberOf(org.xowl.infra.lang.owl2.IRI elem) {
     ...
     * @param elem The element value to remove (must not be null)
     */
    private void doPropertyRemoveMemberOf(org.xowl.infra.lang.owl2.IRI elem) {
     ...
     * @param elem The element value to add (must not be null)
     */
    private void doGraphAddMemberOf(org.xowl.infra.lang.owl2.IRI elem) {
     ...
     * @param elem The element value to remove (must not be null)
     */
    private void doGraphRemoveMemberOf(org.xowl.infra.lang.owl2.IRI elem) {
     ...
     * @param elem The element value to add (must not be null)
     */
    private void doDispatchAddMemberOf(org.xowl.infra.lang.owl2.IRI elem) {
     ...
     * @param elem The element value to remove (must not be null)
     */
    private void doDispatchRemoveMemberOf(org.xowl.infra.lang.owl2.IRI elem) {
        doGraphRemoveMemberOf(elem);
    }

    @Override
    public org.xowl.infra.lang.owl2.IRI getMemberOf() {
        return __implMemberOf;
    }

    @Override
    public void setMemberOf(org.xowl.infra.lang.owl2.IRI elem) {
