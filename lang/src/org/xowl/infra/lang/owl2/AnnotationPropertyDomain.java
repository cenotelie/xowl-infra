...
public class AnnotationPropertyDomain implements org.xowl.infra.lang.owl2.AnnotationAxiom, org.xowl.infra.lang.owl2.Annotation_OR_AnnotationAssertion_OR_AnnotationPropertyDomain_OR_AnnotationPropertyRange_OR_SubAnno4 {
    // <editor-fold defaultstate="collapsed" desc="Property annotDomain">
    public static interface annotDomain {
    ...
    private static class annotDomain_impl implements org.xowl.infra.lang.owl2.AnnotationPropertyDomain.annotDomain {
        private org.xowl.infra.lang.owl2.AnnotationPropertyDomain domain;
        ...
        public annotDomain_impl(org.xowl.infra.lang.owl2.AnnotationPropertyDomain domain) {
            this.domain = domain;
        }
    }
    private annotDomain_impl dataAnnotDomain;
    public org.xowl.infra.lang.owl2.AnnotationPropertyDomain.annotDomain __getImplOfannotDomain() { return dataAnnotDomain; }
    public boolean setAnnotDomain(org.xowl.infra.lang.owl2.IRI elem) {
        if (dataAnnotDomain.get() != null) {
            if (elem == null) {
                if (!dataAnnotDomain.user_check_remove(dataAnnotDomain.get())) return false;
                dataAnnotDomain.user_remove(dataAnnotDomain.get());
            } else {
                if (!dataAnnotDomain.user_check_replace(dataAnnotDomain.get(), elem)) return false;
                dataAnnotDomain.user_remove(dataAnnotDomain.get());
                dataAnnotDomain.user_add(elem);
            }
        } else {
            if (elem == null) return true;
            if (!dataAnnotDomain.user_check_add(elem)) return false;
            dataAnnotDomain.user_add(elem);
        }
        return true;
    }
    public org.xowl.infra.lang.owl2.IRI getAnnotDomain() { return dataAnnotDomain.get(); }
    // </editor-fold>
    ...
    private static class annotProperty_impl implements org.xowl.infra.lang.owl2.Annotation_OR_AnnotationAssertion_OR_AnnotationPropertyDomain_OR_AnnotationPropertyRange_OR_SubAnno4.annotProperty {
        ...
        public annotProperty_impl(org.xowl.infra.lang.owl2.AnnotationPropertyDomain domain) {
            this.domain = domain;
        }
    }
    ...
    private static class file_impl implements org.xowl.infra.lang.owl2.Axiom.file {
        ...
        public file_impl(org.xowl.infra.lang.owl2.AnnotationPropertyDomain domain) {
            this.domain = domain;
        }
    }
    ...
    private static class line_impl implements org.xowl.infra.lang.owl2.Axiom.line {
        ...
        public line_impl(org.xowl.infra.lang.owl2.AnnotationPropertyDomain domain) {
            this.domain = domain;
        }
    }
    ...
    private static class annotations_impl implements org.xowl.infra.lang.owl2.Annotation_OR_Axiom_OR_Ontology.annotations {
        ...
        public annotations_impl(org.xowl.infra.lang.owl2.AnnotationPropertyDomain domain) {
            this.domain = domain;
    ...
    public AnnotationPropertyDomain() {
        dataAnnotDomain = new annotDomain_impl(this);
