...
public class SubDataPropertyOf implements org.xowl.infra.lang.owl2.DataPropertyAxiom, org.xowl.infra.lang.owl2.DataPropertyAssertion_OR_DataPropertyDomain_OR_DataPropertyElement_OR_DataPropertyRange_OR_DataProp5 {
    // <editor-fold defaultstate="collapsed" desc="Property superDataProperty">
    public static interface superDataProperty {
    ...
    private static class superDataProperty_impl implements org.xowl.infra.lang.owl2.SubDataPropertyOf.superDataProperty {
        private org.xowl.infra.lang.owl2.SubDataPropertyOf domain;
        ...
        public superDataProperty_impl(org.xowl.infra.lang.owl2.SubDataPropertyOf domain) {
            this.domain = domain;
        }
    }
    private superDataProperty_impl dataSuperDataProperty;
    public org.xowl.infra.lang.owl2.SubDataPropertyOf.superDataProperty __getImplOfsuperDataProperty() { return dataSuperDataProperty; }
    public boolean setSuperDataProperty(org.xowl.infra.lang.owl2.DataPropertyExpression elem) {
        if (dataSuperDataProperty.get() != null) {
            if (elem == null) {
                if (!dataSuperDataProperty.user_check_remove(dataSuperDataProperty.get())) return false;
                dataSuperDataProperty.user_remove(dataSuperDataProperty.get());
            } else {
                if (!dataSuperDataProperty.user_check_replace(dataSuperDataProperty.get(), elem)) return false;
                dataSuperDataProperty.user_remove(dataSuperDataProperty.get());
                dataSuperDataProperty.user_add(elem);
            }
        } else {
            if (elem == null) return true;
            if (!dataSuperDataProperty.user_check_add(elem)) return false;
            dataSuperDataProperty.user_add(elem);
        }
        return true;
    }
    public org.xowl.infra.lang.owl2.DataPropertyExpression getSuperDataProperty() { return dataSuperDataProperty.get(); }
    // </editor-fold>
    ...
    private static class dataProperty_impl implements org.xowl.infra.lang.owl2.DataPropertyAssertion_OR_DataPropertyDomain_OR_DataPropertyElement_OR_DataPropertyRange_OR_DataProp5.dataProperty {
        ...
        public dataProperty_impl(org.xowl.infra.lang.owl2.SubDataPropertyOf domain) {
            this.domain = domain;
        }
    }
    ...
    private static class file_impl implements org.xowl.infra.lang.owl2.Axiom.file {
        ...
        public file_impl(org.xowl.infra.lang.owl2.SubDataPropertyOf domain) {
            this.domain = domain;
        }
    }
    ...
    private static class line_impl implements org.xowl.infra.lang.owl2.Axiom.line {
        ...
        public line_impl(org.xowl.infra.lang.owl2.SubDataPropertyOf domain) {
            this.domain = domain;
        }
    }
    ...
    private static class annotations_impl implements org.xowl.infra.lang.owl2.Annotation_OR_Axiom_OR_Ontology.annotations {
        ...
        public annotations_impl(org.xowl.infra.lang.owl2.SubDataPropertyOf domain) {
            this.domain = domain;
    ...
    public SubDataPropertyOf() {
        dataSuperDataProperty = new superDataProperty_impl(this);
