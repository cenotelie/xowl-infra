...
class DenotationParser extends LRkParser {
    ...
    private static final Symbol[] variables = {
        ...
        new Symbol(0x0040, "rule_represents"), 
        new Symbol(0x0041, "rule_is"), 
        new Symbol(0x0042, "rule_symbols"), 
        new Symbol(0x0043, "rule_symbol"), 
        new Symbol(0x0044, "rule_symbol_properties"), 
        new Symbol(0x0045, "rule_symbol_relations"), 
        new Symbol(0x0046, "rule_symbol_relation"), 
        new Symbol(0x0047, "rule_symbol_bound"), 
        new Symbol(0x0048, "rule_mappings"), 
        new Symbol(0x0049, "rule_mapping"), 
        new Symbol(0x004A, "rule_mapping_alias"), 
        new Symbol(0x004B, "rule_mapping_properties"), 
        new Symbol(0x004C, "rule_mapping_property"), 
        new Symbol(0x004D, "rule_mapping_bindings"), 
        new Symbol(0x004E, "rule_mapping_binding"), 
        new Symbol(0x004F, "expression_list"), 
        new Symbol(0x0050, "expression"), 
        new Symbol(0x0051, "exp_or"), 
        new Symbol(0x0052, "exp_and"), 
        new Symbol(0x0053, "exp_logical"), 
        new Symbol(0x0054, "exp_relational"), 
        new Symbol(0x0055, "exp_numeric"), 
        new Symbol(0x0056, "exp_add"), 
        new Symbol(0x0057, "exp_mult"), 
        new Symbol(0x0058, "exp_unary"), 
        new Symbol(0x0059, "exp_primary"), 
        new Symbol(0x005A, "exp_bracketted"), 
        new Symbol(0x005B, "iri"), 
        new Symbol(0x005C, "prefixedName"), 
        new Symbol(0x005D, "literal"), 
        new Symbol(0x005E, "literal_rdf"), 
