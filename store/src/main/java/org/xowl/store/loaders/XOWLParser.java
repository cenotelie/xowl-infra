...
class XOWLParser extends RNGLRParser {
    ...
    public static class ID {
         ...
         */
        public static final int axiomFunctionDefinition = 0x00BB;
        /**
         * The unique identifier for variable xowl_query
         */
        public static final int xowl_query = 0x00BC;
        /**
         * The unique identifier for variable xowl_query_vars
         */
        public static final int xowl_query_vars = 0x00BD;
        /**
         * The unique identifier for variable xowl_query_assertions
         */
        public static final int xowl_query_assertions = 0x00BE;
        /**
         * The unique identifier for variable xowl_query_assertion
         */
        public static final int xowl_query_assertion = 0x00BF;
        /**
         * The unique identifier for variable xowl_insert
         */
        public static final int xowl_insert = 0x00C0;
        /**
         * The unique identifier for variable _Axiom_
         */
        public static final int _Axiom_ = 0x0136;
    }
    /**
    ...
    private static final Symbol[] variables = {
        ...
        new Symbol(0x00BB, "axiomFunctionDefinition"), 
        new Symbol(0x00BC, "xowl_query"), 
        new Symbol(0x00BD, "xowl_query_vars"), 
        new Symbol(0x00BE, "xowl_query_assertions"), 
        new Symbol(0x00BF, "xowl_query_assertion"), 
        new Symbol(0x00C0, "xowl_insert"), 
        new Symbol(0x00C1, "_gen_V193"), 
        new Symbol(0x00C2, "_gen_V194"), 
        new Symbol(0x00C5, "_gen_V197"), 
        new Symbol(0x00C7, "_gen_V199"), 
        new Symbol(0x00C8, "_gen_V200"), 
        new Symbol(0x00CB, "_gen_V203"), 
        new Symbol(0x00CE, "_gen_V206"), 
        new Symbol(0x00D0, "_gen_V208"), 
        new Symbol(0x00D3, "_gen_V211"), 
        new Symbol(0x00D5, "_gen_V213"), 
        new Symbol(0x00D7, "_gen_V215"), 
        new Symbol(0x00D9, "_gen_V217"), 
        new Symbol(0x00DC, "_gen_V220"), 
        new Symbol(0x00E5, "_gen_V229"), 
        new Symbol(0x00E7, "_gen_V231"), 
        new Symbol(0x00F5, "_gen_V245"), 
        new Symbol(0x00F7, "_gen_V247"), 
        new Symbol(0x00F9, "_gen_V249"), 
        new Symbol(0x00FC, "_gen_V252"), 
        new Symbol(0x00FE, "_gen_V254"), 
        new Symbol(0x010B, "_gen_V267"), 
        new Symbol(0x010D, "_gen_V269"), 
        new Symbol(0x0113, "_gen_V275"), 
        new Symbol(0x0114, "_gen_V276"), 
        new Symbol(0x0116, "_gen_V278"), 
        new Symbol(0x0118, "_gen_V280"), 
        new Symbol(0x0122, "_gen_V290"), 
        new Symbol(0x0123, "_gen_V291"), 
        new Symbol(0x0124, "_gen_V292"), 
        new Symbol(0x0125, "_gen_V293"), 
        new Symbol(0x0126, "_gen_V294"), 
        new Symbol(0x0127, "_gen_V295"), 
        new Symbol(0x0128, "_gen_V296"), 
        new Symbol(0x0129, "_gen_V297"), 
        new Symbol(0x012A, "_gen_V298"), 
        new Symbol(0x012B, "_gen_V299"), 
        new Symbol(0x012C, "_gen_V300"), 
        new Symbol(0x012D, "_gen_V301"), 
        new Symbol(0x012F, "_gen_V303"), 
        new Symbol(0x0130, "_gen_V304"), 
        new Symbol(0x0131, "_gen_V305"), 
        new Symbol(0x0132, "_gen_V306"), 
        new Symbol(0x0133, "_gen_V307"), 
        new Symbol(0x0134, "_gen_V308"), 
        new Symbol(0x0135, "_gen_V309"), 
        new Symbol(0x0136, "_Axiom_") };
    /**
