 ...
 * Represents a lexer
 */
class FunctionalXOWLLexer extends ContextFreeLexer {
    /**
     * The automaton for this lexer
     */
    private static final Automaton commonAutomaton = Automaton.find(FunctionalXOWLLexer.class, "FunctionalXOWLLexer.bin");
     ...
     * @param input The lexer's input
     */
    public FunctionalXOWLLexer(InputStreamReader input) {
        super(commonAutomaton, terminals, 0x0006, input);
    }
}
