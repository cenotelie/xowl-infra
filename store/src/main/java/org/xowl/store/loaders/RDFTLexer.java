...
class RDFTLexer extends PrefetchedLexer {
    ...
    public static class ID {
         ...
         */
        public static final int QVAR = 0x001C;
        /**
         ...
         */
        public static final int MARKER_NOT = 0x001E;
        /**
         ...
         */
        public static final int MARKER_META = 0x001D;
        /**
     ...
     * @param input The lexer's input
     */
    public RDFTLexer(InputStream input) throws IOException {
        super(automaton, terminals, 0x0006, input);
    }
}
