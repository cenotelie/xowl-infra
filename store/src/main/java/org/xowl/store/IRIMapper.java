...
public class IRIMapper {
    ...
    public static IRIMapper getDefault() {
        ...
        mapper.addSimpleMap(IRIs.OWL2, "resource:///org/xowl/store/base/owl2.ttl");
        mapper.addSimpleMap(IRIs.RDF, "resource:///org/xowl/store/base/rdf.ttl");
        mapper.addSimpleMap(IRIs.RDFS, "resource:///org/xowl/store/base/rdfs.ttl");
        // map the xOWL abstract syntax
        mapper.addRegexpMap(IRIs.XOWL_LANG + "(.*)", "resource:///org/xowl/lang/defs/\\1.fs");
        // map the OWL2 RL reasoning rules
        mapper.addRegexpMap(IRIs.XOWL_RULES + "(.*)", "resource:///org/xowl/store/rules/\\1.rdft");
        return mapper;
    }
}
