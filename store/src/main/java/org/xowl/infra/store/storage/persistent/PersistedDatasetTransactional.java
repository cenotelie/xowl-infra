...
import org.xowl.infra.store.storage.DatasetTransactional;
...
/**
 * Transactional implementation of a quad storage system that is persisted using a write-ahead log, presumably in a file on disk.
 *
 * @author Laurent Wouters
 */
public class PersistedDatasetTransactional extends PersistedDataset implements DatasetTransactional {
    /**
     * The storage system
     */
     ...
     */
    public PersistedDatasetTransactional(File directory, boolean isReadonly) throws IOException {
